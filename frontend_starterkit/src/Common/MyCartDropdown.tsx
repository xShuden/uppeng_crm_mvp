                    ...
                    <div className="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                        <Row className="align-items-center">
                            ...
                            <div className="col-auto">
                                <span className="badge bg-info-subtle text-info fs-13"> <span className="cartitem-badge"> {cartItem} </span> items</span>
                            </div>
                        </Row>
                    </div>
                            ...
                            {cartData.map((item, key) => (
                                <div className="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2" key={key}>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="ps-2">
                                            <Button variant='ghost-secondary' type="button" className="btn btn-icon btn-sm btn-ghost-danger remove-item-btn" onClick={(e) => { removeItem(e.target); }}><i
